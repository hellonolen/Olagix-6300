...
const {FiCreditCard, FiCheck, FiStar, FiZap, FiCrown, FiDollarSign, FiShield, FiTrendingUp} = FiIcons;
...
const Pricing = () => {
  ...
  const plans = [
    ...
    },
    {
      ...
      buttonClass: 'bg-purple-600 hover:bg-purple-700 text-white font-medium py-2.5 px-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-200',
      popular: false
    }
  ];
  ...
  return (
    <Layout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Feature Comparison */}
        <div className="bg-white rounded-2xl card-shadow overflow-hidden mb-16">
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <tbody className="divide-y divide-gray-200">
                <tr>
                  <td className="py-4 px-6 font-medium">Business Profiles</td>
                  <td className="py-4 px-6 text-center">1</td>
                  <td className="py-4 px-6 text-center">5</td>
                  <td className="py-4 px-6 text-center">10</td>
                </tr>
                <tr>
                  <td className="py-4 px-6 font-medium">Dispute Letters</td>
                  <td className="py-4 px-6 text-center">3/month</td>
                  <td className="py-4 px-6 text-center">Unlimited</td>
                  <td className="py-4 px-6 text-center">Unlimited</td>
                </tr>
                <tr>
                  <td className="py-4 px-6 font-medium">Rent Reporting</td>
                  <td className="py-4 px-6 text-center">+$19/mo</td>
                  <td className="py-4 px-6 text-center">+$19/mo</td>
                  <td className="py-4 px-6 text-center"><SafeIcon icon={FiCheck} className="w-5 h-5 text-green-500 mx-auto" /></td>
                </tr>
                <tr>
                  <td className="py-4 px-6 font-medium">Premium Tradeline</td>
                  <td className="py-4 px-6 text-center">Additional Fee</td>
                  <td className="py-4 px-6 text-center">Additional Fee</td>
                  <td className="py-4 px-6 text-center"><SafeIcon icon={FiCheck} className="w-5 h-5 text-green-500 mx-auto" /></td>
                </tr>
                <tr>
